...
public class YouTubeInfo extends VideoInfo {
	...
	public static class StreamCombined extends StreamInfo {
		...
		public void setVideo(Encoding video) {
			this.video = video;
		}

		public YoutubeQuality getVq() {
			return vq;
		}

		public void setVq(YoutubeQuality vq) {
			this.vq = vq;
		}
		...
		public StreamCombined(Container c, Encoding v, YoutubeQuality vq,
				Encoding a, AudioQuality aq) {
			super(c);
